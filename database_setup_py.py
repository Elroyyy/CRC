...
def create_database():
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS space_rental (
            ...
            space_requested VARCHAR(100) NOT NULL,
            event_date DATE NOT NULL,
    ...
    if event_count == 0:
        ...
        sample_events = [
            ('Easter Celebration Service', 'A joyous celebration of Christ\'s resurrection with special music, testimonies, and communion.', '2024-03-31', None),
            ('Community Outreach Program', 'Serving our local community with food distribution and prayer ministry.', '2024-03-15', None),
            ('Youth Revival Conference', 'A powerful weekend of worship, teaching, and fellowship for our young people.', '2024-02-28', None),
            ('Christmas Celebration', 'A beautiful Christmas service celebrating the birth of our Savior with carols and candlelight.', '2024-12-25', None),
            ('Baptism Sunday', 'A sacred time of baptisms as new believers publicly declare their faith.', '2024-11-12', None)
        ]
